...
import { indexCar, batchIndexCars } from '../services/api'
    ...
    <>
      ...
      {success && (
        <div className="alert alert-success">
          <strong>Success!</strong> Car indexed: {success.car_id}, plate: {success.plate_number}, embedding dim: {success.embedding_dim}
        </div>
      )}
    </>
  )
        ...
        <div className="card">
          ...
          <div className="batch-summary">
            ...
            <div className="batch-stat" style={{ background: 'var(--success-light)' }}>
              <div className="batch-stat-value" style={{ color: 'var(--success)' }}>{results.succeeded}</div>
